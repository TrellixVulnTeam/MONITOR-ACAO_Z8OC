...
country_select = st.sidebar.selectbox('Selecione um país:', countries)
...
if from_date > to_date:
    st.sidebar.error('Data de início maior que a data final')
else:
    ...
    try:
        ...
        if carregar_dados:
            ...
            descricao = st.dataframe(dfgi.describe())
